  ...
  return (
    <div style={{ padding: '24px' }}>
      ...
      >
          ...
          <Col xs={24} sm={12} lg={6}>
            <Card>
              <Statistic
                ...
                value={stats ? (stats.active_critical + stats.active_high) : 0}
                prefix={<ExclamationCircleOutlined />}
        ...
        {/* Urgency Alert */}
        {(stats?.active_critical || 0) > 0 && (
          <Alert
            message={`${stats?.active_critical || 0} critical alerts require immediate attention`}
            type="error"
            showIcon
          ...
          >
            ...
            >
              <Select
                ...
                allowClear
              >
                <Option value="SUPERUSER">Super User (Developer)</Option>
                ...
                <Option value="MAIN_CENTER_APPROVER">Main Center Approver</Option>
            ...
            <Form.Item name="is_dismissible" valuePropName="checked" style={{ marginBottom: 0 }}>
