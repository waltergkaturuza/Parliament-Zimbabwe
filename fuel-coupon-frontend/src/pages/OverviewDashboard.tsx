// src/pages/OverviewDashboard.tsx - Simple Overview Dashboard for General Users
...
const OverviewDashboard: React.FC = () => {
    ...
    const { data: stats, isLoading, isError, error } = useQuery<StatsData>({
        queryKey: ['overview-dashboard-stats'],
    ...
    return (
        <div className={styles.dashboardContainer}>
                ...
                <ul className={styles.navList}>
                    {isAdmin && (
                        <>
                            ...
                            <li className={styles.navItem}><Link to="/dashboard/analytics" className={styles.navLink}>Advanced Analytics</Link></li>
                        </>
                    )}
            ...
            <div className={styles.mainContent}>
                ...
                <p className="text-gray-600 mb-4">Quick overview of your fuel coupon system</p>
                ...
                {(isAdmin || isMainCenter) && (
                    <div className="mt-6 p-4 bg-blue-50 rounded-lg">
                        <h3 className="text-lg font-semibold mb-2">Quick Actions</h3>
                        <div className="space-x-2">
                            <Link to="/dashboard/analytics" className="text-blue-600 hover:underline">View Detailed Analytics</Link>
                            <span>•</span>
                            <Link to="/coupons/create" className="text-blue-600 hover:underline">Create New Coupons</Link>
                        </div>
                    </div>
                )}
            </div>
