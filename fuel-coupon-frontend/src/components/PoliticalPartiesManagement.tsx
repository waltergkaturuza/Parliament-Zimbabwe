  ...
  const columns: ColumnsType<PoliticalParty> = [
    ...
    },
    {
      ...
      filters: [
        ...
        { text: 'Coalition', value: 'COALITION' },
    ...
    },
    {
      ...
      filters: [
        ...
        { text: 'Disbanded', value: 'DISBANDED' },
    ...
    },
    {
      ...
      filters: [
        { text: 'Parliamentary', value: 'true' },
        { text: 'Non-Parliamentary', value: 'false' },
      ],
    },
    {
      title: 'Founded',
      ...
      sorter: (a, b) => {
        if (!a.founded_date && !b.founded_date) return 0;
        if (!a.founded_date) return 1;
        if (!b.founded_date) return -1;
        return new Date(a.founded_date).getTime() - new Date(b.founded_date).getTime();
      },
    },
    {
      title: 'Actions',
        ...
        <Space>
          ...
          <Tooltip title="View Members">
            <Button
              ...
              icon={<UserOutlined />}
              onClick={() => {
                // Navigate to members view - implement as needed
    ...
    <div style={{ padding: '24px' }}>
      ...
      <Row justify="space-between" align="middle" style={{ marginBottom: 24 }}>
        <Col>
          ...
          <Text type="secondary">
            Manage political parties and their affiliations
          </Text>
        </Col>
        <Col>
          <Space>
