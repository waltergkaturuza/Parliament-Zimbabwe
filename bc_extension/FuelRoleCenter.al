// Simplified Role Center for Fuel Management Users
page 50114 "Fuel Manager Role Center"
{
    PageType = RoleCenter;
    ...
    layout
    {
        area(RoleCenter)
        {
            ...
            part(TransactionList; "Fuel Transaction Activities")
            {
                ApplicationArea = All;
            }
        }
...
page 50115 "Fuel Transaction Activities"
{
    PageType = CardPart;
