#!/usr/bin/env python3
"""
Test the public development API endpoints
"""
import requests
import json
...
def main():
    ...
    endpoints_to_test = [
        ...
        ("/beneficiaries/unique-categories/", "Unique Categories (Auth Required)"),
        ("/beneficiaries/unique-parties/", "Unique Parties (Auth Required)"),
    ]
